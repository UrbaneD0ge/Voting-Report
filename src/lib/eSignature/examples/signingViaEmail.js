...
function makeEnvelope(args) {
  ...
  doc2DocxBytes = readFileSync(args.doc2File);
  doc3PdfBytes = readFileSync(args.doc3File);
  ...
  let doc2 = new Document.constructFromObject({
  ...
  let doc3 = new Document.constructFromObject({
...
export default { sendEnvelope, makeEnvelope, document1 };
